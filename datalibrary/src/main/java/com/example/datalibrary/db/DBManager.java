...
public class DBManager {
    ...
    public synchronized SQLiteDatabase openDatabase() {
        if (mOpenCounter.incrementAndGet() == 1) {
            ...
            try {
                ...
                LogUtils.e(TAG, "openDatabase e = " + e.getMessage());
    ...
    public boolean addGroup(Group group) {
        ...
        try {
            ...
            LogUtils.e(TAG, "addGroup e = " + e.getMessage());
            e.printStackTrace();
        }
        if (rowId < 0) {
            return false;
        }
        LogUtils.i(TAG, "insert group success:" + rowId);
        closeCursor(cursor);
        return true;
    }
    ...
    public List<Group> queryGroupsByGroupId(String groupId) {
        ...
        try {
            ...
            LogUtils.e(TAG, "queryGroupsByGroupId e = " + e.getMessage());
        } finally {
            closeCursor(cursor);
        }
        return groupList;
    ...
    public boolean addUser(User user) {
        ...
        try {
            ...
            setTransactionSuccessful(mDatabase);
            LogUtils.i(TAG, "insert user success:" + rowId);
        } catch (Exception e) {
            LogUtils.e(TAG, "addUser e = " + e.getMessage());
            return false;
        } finally {
            endTransaction(mDatabase);
        }
    ...
    private void closeCursor(Cursor cursor) {
        if (cursor != null) {
            try {
                ...
                LogUtils.e(TAG, "closeCursor e = " + e.getMessage());
            }
        }
    }
...
//            }
//        } catch (Exception e) {
//            LogUtils.e("shangtest", e.getMessage());
//        } finally {
//            closeCursor(cursor);
//        }
