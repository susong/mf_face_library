...
//        rectF.left = rectF.left + autoTexturePreviewView.getLeft();
//        rectF.right = rectF.right + autoTexturePreviewView.getLeft();
//        rectF.top = rectF.top + autoTexturePreviewView.getTop();
//        rectF.bottom = rectF.bottom + autoTexturePreviewView.getTop();
    }
