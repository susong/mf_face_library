...
public interface FaceConstant {
    ...
    int CODE_ERROR = 1;
    int CODE_FACE_REGISTER = 2;
    int CODE_FACE_REGISTER_RESULT = 3;
    int CODE_FACE_REGISTER_TIPS_RESULT = 4;
    int CODE_FACE_RECOGNITION = 5;
    int CODE_FACE_RECOGNITION_RESULT = 6;
    int CODE_FACE_RECOGNITION_TIPS_RESULT = 7;
    int CODE_CANCEL_FACE_REGISTER_AND_RECOGNITION = 8;
    int CODE_CANCEL_FACE_REGISTER_AND_RECOGNITION_RESULT = 9;
    int CODE_SYNC_FACE_DATA = 10;
    int CODE_SYNC_FACE_DATA_RESULT = 11;
    int CODE_REMOVE_FACE_DATA = 12;
    int CODE_REMOVE_FACE_DATA_RESULT = 13;
    int CODE_MANUAL_CANCEL_FACE_REGISTER = 14;
    int CODE_MANUAL_CANCEL_FACE_RECOGNITION = 15;
    int CODE_PICK_CAR_BY_PLATE = 16;
    int CODE_PICK_CAR_BY_BERTH = 17;
